...
| **Yapisal yorum aramasi** ✅ (`expandWrittenMeasuresGuided`): repeat+DS etkilesiminde aday yorumlar (segno konumlari x once/sonra segment tekrarli/ham x DS-sonu walk-rehberli) uretilir; TXT walk ile birebir eslesen secilir. Baskin cozum: DS bolumu ic tekrarlar olmadan calinir. Korpus birebir eslesme %59,5 → %75,9 (2.268, +490). Rapor 116 high / 928 medium / 1.751 low, storedMismatch 13.391 (−1.303), import-ready 116 giris dry-run gecti (2.275 kutu, 0 hata) | Kalan %24,1 (volta/nested) P2; yazim onayi P1 | P1 — ACILIM %75,9 |
