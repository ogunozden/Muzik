            ...
            {!isSupported ? (
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  ...
                  {isRecording && (
                    <Badge ariaLabel={t("recording.status")} color="danger" variant="solid">{t("recording.recordingActive")}</Badge>
                  )}
                  {isProcessing && (
                    <Badge ariaLabel={t("recording.processingStatus")} color="warning" variant="solid">{t("recording.processingStatus")}</Badge>
                  )}
                </div>
